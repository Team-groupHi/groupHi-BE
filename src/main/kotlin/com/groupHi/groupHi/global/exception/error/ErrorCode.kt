...
enum class ErrorCode(
    ...
    INVALID_SESSION("E001", "Invalid or missing session."),
    HOST_ONLY("E002", "Only the host can perform this action."),
    ...
    ONLY_HOST_CAN_CHANGE_GAME("R005", "Only the host can change the game."), //TODO: delete
    ...
    // BalanceGame
    ONLY_HOST_CAN_START("B001", "Only the host can start the game."), //TODO: delete
    NOT_ALL_PLAYERS_READY("B002", "All players must be ready."),
    INVALID_ROUND_COUNT("B003", "Round count must be between 10 and 20."),
    ONLY_HOST_CAN_NEXT("B004", "Only the host can proceed to the next round."), //TODO: delete
    ONLY_HOST_CAN_END("B005", "Only the host can end the game.") //TODO: delete
}
